...
{ "action": "open_app"|"focus_app"|"close_app"|"minimize_app"|"set_theme"|"set_budget"|"noop", "app": "${apps}", "theme": "cupertino"|"dark"|"win95"|"material"|"high-contrast"|"custom", "tokenLimit": number, "rationale": "..." }
